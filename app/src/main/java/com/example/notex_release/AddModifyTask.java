...
public class AddModifyTask extends AppCompatActivity {
    ...
    TextView dateTextTask; //дата в таске
    Button save_btn;
            ...
            if (isModify) {
                mydb.updateTask(task_id, edit_text.getText().toString(), new SimpleDateFormat("E, dd MMMM yyyy").format(calendar.getTime()));
                   ...
                   /* setContentView(R.layout.task_list_row);
                    dateTextTask = findViewById(R.id.date_task); //дата в таске
                    dateTextTask.setText(new SimpleDateFormat("E, dd MMMM yyyy").format(calendar.getTime()));*/
